...
@Component({
  selector: 'app-exonerados-admin',
  templateUrl: './exonerados-admin.component.html',
  styleUrls: ['./exonerados-admin.component.scss']
})
export class ExoneradosAdminComponent implements OnInit, OnDestroy {
