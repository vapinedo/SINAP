...
@Component({
  selector: 'app-reglas-sistema-admin',
  templateUrl: './reglas-sistema-admin.component.html',
  styleUrls: ['./reglas-sistema-admin.component.scss']
})
export class ReglasSistemaAdminComponent implements OnInit, OnDestroy {
